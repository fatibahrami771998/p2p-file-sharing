...
# super_super_friends management --------------------------------------------------------
	@classmethod
	def is_super_friend(cls, ip4_peer: str, port_peer: int) -> bool:
		return (ip4_peer, port_peer) in cls.super_friends
	...
	@classmethod
	def add_super_friend(cls, ip4_peer: str, port_peer: int) -> None:
		cls.super_friends.append((ip4_peer, port_peer))

	@classmethod
	def super_friend_index(cls, ip4_peer: str, port_peer: int) -> int:
		return cls.super_friends.index((ip4_peer, port_peer))

	@classmethod
	def get_super_friends_recipients(cls, ip_sender: str, ip4_source: str) -> list:
...
# menu_peer_files management---------------------------------------------------
	...
	@classmethod
	def add_menu_peer_file(cls, ip4_peer: str, port_peer: int, filemd5: str, filename: str) -> None:
		cls.menu_peer_files.append((ip4_peer, port_peer, filemd5, filename))

	@classmethod
	def exist_menu_peer_file(cls, ip4_peer: str, port_peer: int, filemd5: str, filename: str) -> bool:
		return (ip4_peer, port_peer, filemd5, filename) in cls.menu_peer_files

	@classmethod
	def menu_peer_file_index(cls, ip4_peer: str, port_peer: int, filemd5: str, filename: str) -> int:
		return cls.menu_peer_files.index((ip4_peer, port_peer, filemd5, filename))
