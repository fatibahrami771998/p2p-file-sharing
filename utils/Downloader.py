...
class Downloader:
	...
	def __init__(self, host_ip4: str, host_port: int, packet: str, file_name: str):
	...
	def __connect(self, ip4_peer: str, port_peer: int, packet: str) -> socket.socket:
	...
	def start(self) -> None:
		...
		try:
			sock = self.__connect(self.host_ip4, self.host_port, self.packet)
		except socket.error as e:
			shell_colors.print_red(f'\nImpossible to send data to {self.host_ip4} [{self.host_port}]: {e}\n')
			return
